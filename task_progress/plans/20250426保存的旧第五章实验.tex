...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/autocluster_workflow.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{figures/exp_workflow.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/legend_plot.pdf} % 确保 legend.png 存在
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}{0.49\linewidth} % 每张图占 48% 宽度
    \centering
    \includegraphics[width=\linewidth]{figures/beers_error.pdf} % 替换为实际图片
  ...
  \begin{subfigure}{0.49\linewidth}
    \centering
    \includegraphics[width=\linewidth]{figures/flights_error.pdf}
  ...
  \begin{subfigure}{0.49\linewidth}
    \centering
    \includegraphics[width=\linewidth]{figures/rayyan_error.pdf}
  ...
  \begin{subfigure}{0.49\linewidth}
    \centering
    \includegraphics[width=\linewidth]{figures/hospital_error.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\linewidth]{figures/legend.pdf} % 确保 legend.png 存在
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}{0.48\linewidth} % 图片尺寸增大
    \centering
    \includegraphics[width=\linewidth]{figures/mode_beers_combined_scores.pdf}
  ...
  \begin{subfigure}{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{figures/mode_flights_combined_scores.pdf}
  ...
  \begin{subfigure}{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{figures/mode_rayyan_combined_scores.pdf}
  ...
  \begin{subfigure}{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{figures/mode_hospital_combined_scores.pdf}
  ...
  \begin{subfigure}{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{figures/raha-baran_beers_combined_scores.pdf}
  ...
  \begin{subfigure}{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{figures/raha-baran_flights_combined_scores.pdf}
  ...
  \begin{subfigure}{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{figures/raha-baran_rayyan_combined_scores.pdf}
  ...
  \begin{subfigure}{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{figures/raha-baran_hospital_combined_scores.pdf}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{1.0\linewidth}  % 增大宽度
        \centering
        \includegraphics[width=\linewidth]{figures/alg_comb_metrics.pdf}
    ...
    \begin{subfigure}{1.0\linewidth}  % 增大宽度
        \centering
        \includegraphics[width=\linewidth]{figures/alg_comb_metrics_low.pdf}
...
$^\dagger$ 三种 K‑Means（Baseline, PPS, NF）均使用同一指标集。}
\end{tabular}
...
\vspace{0.6em}
\noindent
表\ref{tab:clean_vs_metric} 汇总了\underline{除 \textit{mode} 之外}的七种清洗策略在
四个不同类别数据集(\textit{beers}, \textit{flights}, \textit{hospital}, \textit{rayyan})
上需要统计的全部过程指标。\emph{横轴=清洗策略}，\emph{纵轴=算法族×指标}；单元格将填入$\Delta\%$ 数值或可视化色块
...
\multicolumn{7}{c}{\textbf{清洗策略}（相对 \textit{mode} 的 $\Delta\%$）}\\
\cmidrule(l){3-10}
 & & \textbf{Raha-Baran} & \textbf{Holoclean} & \textbf{BigDansing} & \textbf{BoostClean} &
...
\multirow{3}{*}{层次型}
 & $\Delta n_{\text{merge}}$     &  &  &  &  &  &  &  &  \\
 & $\Delta h_{\max}$             &  &  &  &  &  &  &  &  \\
 & $\Delta\text{R}_{\text{intra/inter}}$ &  &  &  &  &  &  &  &  \\
\bottomrule
\end{tabular}
\caption{待采集的“\textit{mode}→更强清洗”过程指标列表
（数值将在实验结果中填充）。}
\label{tab:clean_vs_metric}
\end{table}

%-------------------------------------------------
    \item \textbf{全局趋势：跨领域热图} \\
图 \ref{fig:heatmap_beers}--\ref{fig:heatmap_rayyan} 给出了四个领域中的8种清洗×6种算法的平均 $\Delta\%$ 热图；深蓝代表最大的正向改善，深红代表显著退化。  
