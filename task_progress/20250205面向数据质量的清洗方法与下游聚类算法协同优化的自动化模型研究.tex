...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\linewidth]{autocluster_workflow.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\linewidth]{exp_workflow.png}
    \caption{实验设计流程示意图}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{legend_plot.png} % 确保 legend.png 存在
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{legend.png} % 确保 legend.png 存在
