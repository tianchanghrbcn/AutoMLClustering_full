...
output_txt.append(f"Using all columns for clustering: {list(remaining_columns)}")
...
print(f"Best parameters found: damping={best_damping}, preference={best_preference}")
...
with open(output_txt_file, 'w', encoding='utf-8') as f:
    output_txt.append(f"Best parameters found: damping={best_damping}, preference={best_preference}")
    output_txt.append(f"Final number of clusters: {best_n_clusters}")
